...
public class MensajeRespuesta<T> {
	 ...
	 */
	public MensajeRespuesta(String status_mensaje, T objeto_dominio, int code_respuesta) {
	 ...
	 * @param objeto_dominio T objeto de clase dominio
	 */
	public void setObjeto_dominio(T objeto_dominio) {
